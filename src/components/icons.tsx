...
// 小鸡图标
export const ChickenIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
  ...
  >
    {/* 身体 */}
    <circle cx="50" cy="45" r="35" fill="#FFD78A" stroke="#FFB26B" strokeWidth="1.5"/>
    {/* 头部 */}
    <circle cx="50" cy="25" r="20" fill="#FFD78A" stroke="#FFB26B" strokeWidth="1.5"/>
    {/* 眼睛 */}
    <circle cx="40" cy="20" r="3" fill="#222222"/>
    <circle cx="60" cy="20" r="3" fill="#222222"/>
    <circle cx="39" cy="19" r="1" fill="#FFFFFF"/>
    <circle cx="59" cy="19" r="1" fill="#FFFFFF"/>
    {/* 腮红 */}
    <circle cx="32" cy="26" r="5" fill="#FFC0CB" opacity="0.7"/>
    <circle cx="68" cy="26" r="5" fill="#FFC0CB" opacity="0.7"/>
    {/* 嘴巴 */}
    <path d="M50 25 L55 32 L45 32 Z" fill="#FF6B6B"/>
    {/* 翅膀 */}
    <circle cx="30" cy="45" r="12" fill="#FFD78A" stroke="#FFB26B" strokeWidth="1"/>
    <circle cx="70" cy="45" r="12" fill="#FFD78A" stroke="#FFB26B" strokeWidth="1"/>
    {/* 脚 */}
    <path d="M45 70 L40 80 L42 80 L47 72" fill="#FF6B6B"/>
    <path d="M55 70 L60 80 L58 80 L53 72" fill="#FF6B6B"/>
  </svg>
);
...
export const DiamondIcon = ({ className = '', size = 24 }: IconProps) => (
  <svg 
    ...
    className={className}
  >
    <path d="M12 2L5 12l7 7 7-7-7-10z" />
    <path d="M12 2v20" />
    <path d="M5 12h14" />
    <path d="M9.5 6.5l5 5" />
...
export const AwardIcon = ({ className = '', size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="m15.477 12.89-3.477 5.11 3.477 5.11" />
  </svg>
);
...
export const BackpackIcon = ({ className = '', size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M10 14h4" />
    <path d="M9 20v-11c0-1.1.9-2 2-2h2c1.1 0 2 .9 2 2v11" />
    <path d="M16 10a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2" />
  </svg>
);
